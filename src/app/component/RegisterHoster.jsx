const RegisterHoster = () => {
    return (
        <div className="container mx-auto px-[280px] py-[50px]">
            <div className="px-[90px] py-[60px] border-t-8 border-red-500" style={{ boxShadow: "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 2px 6px 2px" }}>
                ...
                <form action="" className="mt-5 space-y-4">
                    ...
                    <div className="">
                        <button className="w-full bg-red-500 py-2 rounded-md text-white">Register</button>
                    </div>
                </form>
            </div>
        </div>
